...
export default function InteractiveCanvas() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      // Fill canvas background with clean base color
      ctx.fillStyle = '#E4E2E3';
      ctx.fillRect(0, 0, width, height);

      // Render 3D perspective wireframe grid ONLY on Desktop view (screen width >= 768px)
      if (!isMobile) {
        ...
        // 1. Draw Radial Perspective Lines (radiating out from 3D vanishing point)
        const rayCount = 36;
        ...
        // 2. Draw Concentric 3D Perspective Rectangles (expanding outward)
        const rectSteps = 18;
