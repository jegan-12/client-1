...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'Hospital Waste' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Dynamic Pricing' },
      { image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Medicine Prediction' },
      { image: `https://picsum.photos/seed/4/800/600?grayscale`, text: 'Tow-Way Connect' }
    ];
